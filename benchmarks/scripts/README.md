...
- `evaluate_frozen_functional_information_ceiling.py`: fit evaluation-only elastic-net classifiers on label-free functional PCs plus motif/accessibility covariates to distinguish assay-limited from shape-model-limited TF failures.
