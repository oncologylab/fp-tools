...
[Download for Windows](https://github.com/oncologylab/fp-tools/releases/download/v0.2.6/fp-tools-gui-windows-x64.exe){ .md-button }
[Download for Apple silicon](https://github.com/oncologylab/fp-tools/releases/download/v0.2.6/fp-tools-gui-macos-apple-silicon.dmg){ .md-button }
