...
- `manuscript/`: tracked BioMedInformatics LaTeX manuscript workspace, including `main.tex`, selected figures, availability notes, and the preview PDF.
...
```bash
python paper/scripts/prepare_biomedinformatics_template.py   --template-zip paper/MDPI_template_ACS.zip   --outdir paper/manuscript
```
