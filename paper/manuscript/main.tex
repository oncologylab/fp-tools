...
real HNF1A- and ATF7-associated sites from the local benchmark fixtures, then created two
...
contrast: HNF1A has stronger B-cell center depletion, whereas ATF7 has stronger
...
matrices were aggregated around HNF1A-associated sites (a normalized B-cell-deeper example)
...
sample-quantile normalization helper as replicate-aware \texttt{detect-tf-binding};
a lower center relative to the local flanks indicates stronger TF protection.
Generated by
