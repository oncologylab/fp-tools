...
real NFYB- and ATF7-associated sites from the local benchmark fixtures, then created two
...
matrices were aggregated around NFYB-associated sites (a B-cell-high BINDetect example)
and ATF7-associated sites (a T-cell-high BINDetect example), then converted into two
