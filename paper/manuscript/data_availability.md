...
- **Pseudobulk demonstration:** public 10x PBMC Multiome ATAC fragments,
  ...
  retrieved through `benchmarks/manifests/10x_pbmc_pseudobulk.tsv` and prepared
...
scripts stay in the main repository. Large reusable example-data archives are
