...
The manuscript normalization panel is regenerated from real demo B/T corrected cut-site matrices around BATF- and ATF7-associated sites; the script creates two deterministic depth-offset replicate profiles per condition to stress-test sample-level quantile normalization while retaining TOBIAS-style central cut-site depletion. BATF is used as a normalized B-cell-deeper example and ATF7 as a normalized T-cell-deeper example.
